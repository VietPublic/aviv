...
<div class="main_content">
  	...
  	<div class="projects_imgs">
  		...
  		<div class="imgs">
  			<a href="<?php echo BASE_PATH.UPLOAD_PATH.'who-we-are'.DS.$o['id']."-".$o['image'];?>" title="<?php echo $o['image'];?>">
  				<img src="<?php echo BASE_PATH.UPLOAD_PATH.'who-we-are'.DS.'thumb'.DS.$o['id']."-".$o['image'];?>" border="0" />
  			</a>
  		</div>
  		<?php endforeach;?>
  	</div>
